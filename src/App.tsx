  ...
  return (
    <div className="max-w-3xl mx-auto px-6 my-6">
      ...
      <ul className="grid grid-cols-3 gap-4 mb-6" onClick={(event: React.SyntheticEvent) => {
        ...
        <li>
          <a href="#alan-wake-ii">
            <img className="pointer-events-none" width="480" height="640" src="https://res.cloudinary.com/fay/image/upload/f_auto,q_auto/v1704202883/tutorials/my-scrolling/alan-wake-ii_avx9ae.jpg" alt="Alan Wake II" />
          </a>
        </li>
        <li>
          <a href="#baldurs-gate-3">
            <img className="pointer-events-none" width="480" height="640" src="https://res.cloudinary.com/fay/image/upload/w_480,h_640,c_fill,g_north/f_auto,q_auto/v1704202883/tutorials/my-scrolling/baldurs-gate-3_ifwsbs.jpg" alt="Baldur's Gate 3" />
          </a>
        </li>
        <li>
          <a href="#bayonetta-origins-cereza-and-the-lost-demon">
            <img className="pointer-events-none" width="480" height="640" src="https://res.cloudinary.com/fay/image/upload/f_auto,q_auto/v1704202883/tutorials/my-scrolling/bayonetta-origins-cereza-and-the-lost-demon_mtfa3u.jpg" alt="Bayonetta Origins: Cereza and the Lost Demon" />
          </a>
        </li>
        <li>
          <a href="#blasphemous-ii">
            <img className="pointer-events-none" width="480" height="640" src="https://res.cloudinary.com/fay/image/upload/w_480,h_640,c_fill,g_south/f_auto,q_auto/v1704202883/tutorials/my-scrolling/blasphemous-ii_tzgyvq.jpg" alt="Blasphemous II" />
          </a>
        </li>
        <li>
          <a href="#dead-space">
            <img className="pointer-events-none" width="512" height="640" src="https://res.cloudinary.com/fay/image/upload/w_480,h_640,c_fill,g_north/f_auto,q_auto/v1704202884/tutorials/my-scrolling/dead-space_ygxrt4.jpg" alt="Dead Space" />
          </a>
        </li>
        <li>
          <a href="#final-fantast-xvi">
            <img className="pointer-events-none" width="480" height="640" src="https://res.cloudinary.com/fay/image/upload/f_auto,q_auto/v1704202884/tutorials/my-scrolling/final-fantast-xvi_tmhsng.jpg" alt="Final Fantasy XVI" />
          </a>
        </li>
        <li>
          <a href="#resident-evil-4">
            <img className="pointer-events-none" width="480" height="640" src="https://res.cloudinary.com/fay/image/upload/f_auto,q_auto/v1704202884/tutorials/my-scrolling/resident-event-4_mpa9um.jpg" alt="Resident Evil 4" />
          </a>
        </li>
        <li>
          <a href="#super-mario-bros-wonder">
            <img className="pointer-events-none" width="480" height="640" src="https://res.cloudinary.com/fay/image/upload/f_auto,q_auto/v1704202885/tutorials/my-scrolling/super-mario-bros-wonder_hypzv5.jpg" alt="Super Mario Bros. Wonder" />
          </a>
        </li>
        <li>
          <a href="#the-legend-of-zelda-tears-of-the-kingdom">
            <img className="pointer-events-none" width="480" height="640" src="https://res.cloudinary.com/fay/image/upload/f_auto,q_auto/v1704202885/tutorials/my-scrolling/the-legend-of-zelda-tears-of-the-kingdom_tk2kx7.jpg" alt="The Legend of Zelda: Tears of the Kingdom" />
          </a>
        </li>
      </ul>
      ...
      <div ref={gamesRef} id="games">
        ...
        <div id="alan-wake-ii" className="grid grid-cols-[200px_auto] gap-8 mb-6">
          <img width="480" height="640" src="https://res.cloudinary.com/fay/image/upload/f_auto,q_auto/v1704202883/tutorials/my-scrolling/alan-wake-ii_avx9ae.jpg" alt="" />
          <div>
        ...
        <div id="baldurs-gate-3" className="grid grid-cols-[200px_auto] gap-8 mb-6">
          <img width="480" height="640" src="https://res.cloudinary.com/fay/image/upload/w_480,h_640,c_fill,g_north/f_auto,q_auto/v1704202883/tutorials/my-scrolling/baldurs-gate-3_ifwsbs.jpg" alt="" />
          <div>
        ...
        <div id="bayonetta-origins-cereza-and-the-lost-demon" className="grid grid-cols-[200px_auto] gap-8 mb-6">
          <img width="480" height="640" src="https://res.cloudinary.com/fay/image/upload/f_auto,q_auto/v1704202883/tutorials/my-scrolling/bayonetta-origins-cereza-and-the-lost-demon_mtfa3u.jpg" alt="" />
          <div>
        ...
        <div id="blasphemous-ii" className="grid grid-cols-[200px_auto] gap-8 mb-6">
          <img width="480" height="640" src="https://res.cloudinary.com/fay/image/upload/w_480,h_640,c_fill,g_south/f_auto,q_auto/v1704202883/tutorials/my-scrolling/blasphemous-ii_tzgyvq.jpg" alt="" />
          <div>
        ...
        <div id="dead-space" className="grid grid-cols-[200px_auto] gap-8 mb-6">
          <img width="512" height="640" src="https://res.cloudinary.com/fay/image/upload/w_480,h_640,c_fill,g_north/f_auto,q_auto/v1704202884/tutorials/my-scrolling/dead-space_ygxrt4.jpg" alt="" />
          <div>
        ...
        <div id="final-fantast-xvi" className="grid grid-cols-[200px_auto] gap-8 mb-6">
          <img width="480" height="640" src="https://res.cloudinary.com/fay/image/upload/f_auto,q_auto/v1704202884/tutorials/my-scrolling/final-fantast-xvi_tmhsng.jpg" alt="" />
          <div>
        ...
        <div id="resident-evil-4" className="grid grid-cols-[200px_auto] gap-8 mb-6">
          <img width="480" height="640" src="https://res.cloudinary.com/fay/image/upload/f_auto,q_auto/v1704202884/tutorials/my-scrolling/resident-event-4_mpa9um.jpg" alt="" />
          <div>
        ...
        <div id="super-mario-bros-wonder" className="grid grid-cols-[200px_auto] gap-8 mb-6">
          <img width="480" height="640" src="https://res.cloudinary.com/fay/image/upload/f_auto,q_auto/v1704202885/tutorials/my-scrolling/super-mario-bros-wonder_hypzv5.jpg" alt="" />
          <div>
        ...
        <div id="the-legend-of-zelda-tears-of-the-kingdom" className="grid grid-cols-[200px_auto] gap-8 mb-6">
          <img width="480" height="640" src="https://res.cloudinary.com/fay/image/upload/f_auto,q_auto/v1704202885/tutorials/my-scrolling/the-legend-of-zelda-tears-of-the-kingdom_tk2kx7.jpg" alt="" />
          <div>
